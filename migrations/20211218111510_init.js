exports.up = function (knex) {
    return knex.schema
        .createTableIfNotExists("setting", function (table) {
            table.increments("id");
        ...
        .then(() =>
            knex.schema.createTableIfNotExists("monitor", function (table) {
                table.increments("id");
                ...
                table
                    .string("accepted_statuscodes_json")
                    .notNullable()
                    .defaultTo('["200-299"]');
        ...
        .then(() =>
            knex.schema.createTableIfNotExists("incident", function (table) {
                table.increments("id");
        ...
        .then(() =>
            knex.schema.createTableIfNotExists("heartbeat", function (table) {
                table.increments("id");
        ...
        .then(() =>
            knex.schema.createTableIfNotExists("monitor_tag", function (table) {
                table.increments("id");
                table
                    .integer("monitor_id", 10)
                    .unsigned()
